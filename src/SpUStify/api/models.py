...
class Profile(models.Model):
    ...
    full_name = models.CharField(
        max_length=50, verbose_name='Full Name', null=True, blank=True)
    dob = models.DateField(verbose_name='Date Of Birth', null=True, blank=True)
    email = models.EmailField(
        max_length=254, verbose_name='Email', null=True, blank=True)
    phone = models.CharField(
        max_length=10, verbose_name='Phone Number (+84)', null=True, blank=True)
...
class Song(models.Model):
    name = models.CharField(
        max_length=50, verbose_name='Song Name', unique=True)
    likes = models.PositiveIntegerField(
        default=0, verbose_name='Number Of Likes')
    listens = models.PositiveIntegerField(
        default=0, verbose_name='Number Of Listens')
    ...
    def save(self, *args, **kwargs):
        self.likes = UserPlayedSong.objects.filter(
...
class Playlist(models.Model):
    ...
    name = models.CharField(
        max_length=50, verbose_name='Playlist Name', unique=True)
...
class UserPlayedPlaylist(models.Model):
    account = models.ForeignKey(User, on_delete=models.CASCADE)
    played_playlist = models.ForeignKey(
        PlayedPlaylist, on_delete=models.CASCADE)
    liked = models.BooleanField()
