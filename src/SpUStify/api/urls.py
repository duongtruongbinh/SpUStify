...
urlpatterns = [
    ...
    path('your_profile/', views.ProfilePageAPI.as_view(), name="your profile"),
    path('artists/', views.ArtistsPageAPI.as_view(), name="artists"),
    path('artists/<str:pk>/', views.ArtistsPageAPI.as_view(), name="artist detail"),
    path('songs/', views.SongsPageAPI.as_view(), name="songs"),
    path('songs/<str:pk>/', views.SongsPageAPI.as_view(), name="detailed song"),
    ...
    path('playlists/<str:pk>/', views.PlaylistsPageAPI.as_view(), name="detailed playlist"),
]