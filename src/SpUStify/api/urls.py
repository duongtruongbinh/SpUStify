...
urlpatterns = [
    ...
    # Detail Account Page
    path('accounts/<str:account_id>',
         AccountViewAPI.as_view(), name="get_account"),
    path('accounts/<str:account_id>/edit',
         DeleteAccountAPI.as_view(), name="edit_account"),
    ...
    path('artists/<str:artist_id>/edit/',
         EditArtistAPI.as_view(), name="edit_artist"),
    ...
    path('songs/<str:song_id>/add-to-playlist/<int:playlist_id>',
         AddSongToPlaylistAPI.as_view(), name='add_song_to_playlist'),
    ...
    path('playlists/<str:playlist_id>/',
         PlaylistsViewAPI.as_view(), name="get_playlist"),
    path('playlists/<str:playlist_id>/songs/',
         SongsOfPlaylistAPI.as_view(), name="get_songs_playlist"),
    path('playlists/<str:playlist_id>/edit/',
         EditPlaylistAPI.as_view(), name="edit_playlist"),
    path('playlists/<str:playlist_id>/remove/<str:song_id>',
         RemoveSongFromPlaylist.as_view(), name="remove_song_from_playlist"),
    path('playlists/<str:playlist_id>/play/',
         PlayPlaylistAPI.as_view(), name='play_playlist'),
    path('playlists/<str:playlist_id>/like/',
         LikePlaylistAPI.as_view(), name='like_playlist'),
    path('your_playlists/', YourPlaylistsViewAPI.as_view(),
         name="get_your_playlists"),
    path('your_playlists/<str:playlist_id>',
         YourPlaylistsViewAPI.as_view(), name="get_your_playlist"),
]
